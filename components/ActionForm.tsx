...
export const ActionForm: React.FC<Props> = ({ }) => {
  ...
  return (
    <form className="p-4 h-full max-w-md bg-white text-xs flex flex-col content-between" action={createAction}>
      <div className="flex-col">
        <div className="flex flex-col justify-between">
          <div className="flex">
            <div>
              <div className='flex flex-col pt-[6px] mr-2'>
                <input type="checkbox" className={cn("appearance-none border-orange-500 border-2 checked:bg-orange-500 transition duration-200 h-5 w-5 rounded-full cursor-pointer")}>
                </input>
              </div>
            </div>
            <div>
